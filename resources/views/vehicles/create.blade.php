                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="vehicle_registration"
                                                value="{{ old('vehicle_registration') }}" class="form-control">
                                        </div>

                                        <div class="col-md-4">
                                            <label class="form-label">Vehicle Chassis</label>
                                            <input type="text" name="vehicle_chesis" value="{{ old('vehicle_chesis') }}"
                                                class="form-control">
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group datepicker-group">
                                                <input type="text" name="vehicle_puc_date"
                                                    value="{{ old('vehicle_puc_date') }}" class="form-control datepicker"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group datepicker-group">
                                                <input type="text" name="vehicle_fitness_exp_date"
                                                    value="{{ old('vehicle_fitness_exp_date') }}"
                                    ...
                                    <div class="row g-3 mt-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group datepicker-group">
                                                <input type="text" name="vehicle_permit_renewal_date"
                                                    value="{{ old('vehicle_permit_renewal_date') }}"
                                                    class="form-control datepicker" placeholder="YYYY-MM-DD">
                                                <span class="input-group-text calendar-icon">
                                                    <i class="bi bi-calendar"></i>
                                                </span>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group datepicker-group">
                                                <input type="text" name="vehicle_insurance_renew_date"
                                                    value="{{ old('vehicle_insurance_renew_date') }}"
                                                    class="form-control datepicker" placeholder="YYYY-MM-DD">
                                                <span class="input-group-text calendar-icon">
                                                    <i class="bi bi-calendar"></i>
                                                </span>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="vehicle_capacity"
                                                value="{{ old('vehicle_capacity') }}" class="form-control"
