            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div>
                        ...
                        <button class="btn btn-dark btn-sm">Download Report</button>
                    </div>
                </div>
                <div class="card mb-3">
                    <div class="card-body row g-2">

                        <form method="GET" action="{{ route('domestic.shipment.index') }}">
                            <div class="card mb-3">
                                <div class="card-body row g-2">
                                        ...
                                        <td>
                                            <div class="btn-group-vertical">
                                                ...
                                                <a href="{{ route('domestic.shipment.pod', $row->id) }}" target="_blank"
                                                    class="btn btn-sm btn-secondary" title="View POD">
                                                    📄
                                                </a>
                                            </div>
                                        </td>
