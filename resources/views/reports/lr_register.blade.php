    ...
    <main class="app-main">
        <div class="app-content-header">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                       <h3 class="mb-0 text-secondary" style="font-weight: bold;">Filter LR Bookinng</h3>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-end">
                            <li class="breadcrumb-item active">Filter LR Bookinng</li>
                            ...
                            <form action="{{ route('reports.lr_register') }}" method="GET" class="row g-3">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select name="source_address" class="form-select">
                                        ...
                                        @foreach($sourceAddresses as $source)
                                        <option value="{{ $source }}"
                                            {{ request('source_address') == $source ? 'selected' : '' }}>
                                            {{ $source }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select name="destination_address" class="form-select">
                                        ...
                                        <option value="{{ $destination }}"
                                            {{ request('destination_address') == $destination ? 'selected' : '' }}>
                                            {{ $destination }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-12 mt-3">
                                    ...
                                    <a href="{{ route('reports.lr_register') }}"
