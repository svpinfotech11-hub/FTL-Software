                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    <div class="form-check mt-4">
                                        <input type="checkbox" name="branch_wise_invoice" value="{{ old('branch_wise_invoice') }}" class="form-check-input">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="file" name="stamp" value="{{ old('stamp') }}" class="form-control" accept="image/*">
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="company_code" value="{{ old('company_code') }}" class="form-control">
                                </div>

                                <div class="col-md-4">
                                    <label class="form-label">UDYAM Code</label>
                                    <input type="text" name="udyam_code" value="{{ old('udyam_code') }}" class="form-control">
                                </div>

                                <div class="col-md-4">
                                    <label class="form-label">Taxable Services</label>
                                    <input type="text" name="taxable_services" value="{{ old('taxable_services') }}" class="form-control">
                                </div>

                                <div class="col-md-12">
                                    <label class="form-label">Invoice Terms & Condition</label>
                                    <textarea name="invoice_terms" value="{{ old('invoice_terms') }}" class="form-control"></textarea>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="bank_terms" class="form-control">{{ old('bank_terms') }}</textarea>
                                </div>
