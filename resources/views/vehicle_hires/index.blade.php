                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body table-responsive">
                        <table class="table table-bordered table-striped datatable">
                            ...
                            <tbody>
                                @foreach ($vehicleHires as $key => $hire)
                                    <tr>
                                        <td>{{ $key + 1 }}</td>
                                        ...
                                        <td>
                                            <a href="javascript:void(0)" class="vendor-detail"
                                                data-id="{{ $hire->vendor_id }}">
                                                {{ $hire->vendor->vendor_name ?? 'N/A' }}
                                            </a>
                                        </td>

                                        <td>
                                            <a href="javascript:void(0)" class="vehicle-detail"
                                                data-id="{{ $hire->vehicle_id }}">
                                                {{ $hire->vehicle->vehicle_number ?? 'N/A' }}
                                            </a>
                                        </td>

                                        <td>
                                            <a href="javascript:void(0)" class="driver-detail"
                                                data-id="{{ $hire->driver_id }}">
                                                {{ $hire->driver->name ?? 'N/A' }}
                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            <span
                                                class="badge bg-{{ $hire->payment_status == 'Paid' ? 'success' : ($hire->payment_status == 'Partial' ? 'warning' : 'danger') }}">
                                                {{ $hire->payment_status }}
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('vehicle_hires.destroy', $hire->id) }}" method="POST"
                                                class="d-inline">
                                                @csrf
                                                @method('DELETE')
