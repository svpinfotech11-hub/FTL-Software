                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control bg-light"
                                        value="{{ $nextHireRegisterId ?? 'HR001' }}" readonly>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group flatpickr">
                                        <input type="text" name="hire_date" class="form-control" placeholder="YYYY-MM-DD"
                                            value="{{ old('hire_date') }}" data-input>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" step="0.01" name="hire_rate" id="hire_rate"
                                        class="form-control" value="{{ old('hire_rate') }}">
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" step="0.01" name="balance_payable" id="balance_payable"
