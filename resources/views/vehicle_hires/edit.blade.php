...
@section('main-content')
        ...
        <div class="app-content">
            <div class="container-fluid">
                ...
                <div class="card card-primary card-outline">
                    ...
                    <form method="POST" action="{{ route('vehicle_hires.update', $vehicleHire->id) }}"
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control bg-light"
                                        value="{{ $vehicleHire->hire_register_id }}" readonly>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group flatpickr">
                                        <input type="text" name="hire_date" class="form-control" placeholder="YYYY-MM-DD"
                                            value="{{ old('hire_date', optional($vehicleHire->hire_date)->format('Y-m-d')) }}"
                                            data-input>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="driver_id" id="driver_id" class="form-control form-select">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" step="0.01" name="hire_rate" class="form-control"
                                        id="hire_rate" value="{{ old('hire_rate', $vehicleHire->hire_rate) }}">
                                </div>

                                <div class="col-md-4">
                                    <label class="form-label">Advance Paid</label>
                                    <input type="number" step="0.01" name="advance_paid" class="form-control"
                                        id="advance_paid" value="{{ old('advance_paid', $vehicleHire->advance_paid) }}">
                                </div>

                                <div class="col-md-4">
                                    <label class="form-label">Balance Payable</label>
                                    <input type="number" step="0.01" name="balance_payable" class="form-control"
                                        id="balance_payable"
                                        value="{{ old('balance_payable', $vehicleHire->balance_payable) }}" disabled>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="payment_status" class="form-control form-select">
                                        ...
                                        <option value="Pending"
                                            {{ $vehicleHire->payment_status == 'Pending' ? 'selected' : '' }}>Pending
                                        </option>
                                        <option value="Partial"
                                            {{ $vehicleHire->payment_status == 'Partial' ? 'selected' : '' }}>Partial
                                        </option>
                                        <option value="Paid"
                                            {{ $vehicleHire->payment_status == 'Paid' ? 'selected' : '' }}>
                                            Paid</option>
                                    </select>
                                </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    @if ($vehicleHire->rc_document)
                                        <small class="text-muted">
                                            Existing: <a href="{{ asset('storage/' . $vehicleHire->rc_document) }}"
                                ...
                                <div class="col-md-4">
                                    ...
                                    @if ($vehicleHire->insurance_document)
                                        <small class="text-muted">
                                            Existing: <a href="{{ asset('storage/' . $vehicleHire->insurance_document) }}"
                                                target="_blank">View</a>
                                        </small>
                                    @endif
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    @if ($vehicleHire->pan_document)
                                        <small class="text-muted">
                                            Existing: <a href="{{ asset('storage/' . $vehicleHire->pan_document) }}"
                                                target="_blank">View</a>
                                        </small>
                                    @endif
                                </div>
    ...
    <script>
        const hireRate = document.getElementById('hire_rate');
        const advancePaid = document.getElementById('advance_paid');
        const balancePayable = document.getElementById('balance_payable');

        function calculateBalance() {
            const hire = parseFloat(hireRate.value) || 0;
            const advance = parseFloat(advancePaid.value) || 0;
            balancePayable.value = (hire - advance).toFixed(2);
        }

        hireRate.addEventListener('input', calculateBalance);
        advancePaid.addEventListener('input', calculateBalance);
    </script>
@endsection
